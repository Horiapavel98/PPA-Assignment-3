...
/**
 * This class implements the behaviour of a KillerWhale.
...
public class KillerWhale extends Predator
{
    ...
    private final static int MAX_HUNTING_RANGE = 15;
    // Each animal has a breeding age
    private final static int BREEDING_AGE = 2880;
    ...
    private final static double MIN_HABITAT_HEIGHT = 0.3;
    ...
    private static final int MAX_FOOD_LEVEL = 1440;
    // How many steps this entity can live.
    private static final int MAX_AGE = 14400;

    /**
     * Constructor for KillerWhale objects
     * @param field - the current field.
     * @param location - the location of the killer whale.
     * @param sim - the simulator that operates this killer whale actor.
     */
    public KillerWhale(boolean randomAge, Field field, Location location, Simulator sim) {
    ...
    protected Animal getNewAnimal(Field field, Location loc) {
        return new KillerWhale(false, field, loc, super.getSim());
    }

...
/**
 * This class implements the behaviour of a Cod.
...
public class Cod extends Prey
{
    ...
    private static final Color COLOR = new Color(220, 220, 16);
    // Each Prey has a specific food value.
    private static final int MAX_FOOD_VALUE = 125;
    // How much food value can absorb.
    private static final int MAX_FOOD_LEVEL = 250;
    // Each animal has a breeding age
    private static final int BREEDING_AGE = 135;
    // How many young can give birth to.
    private static final int MAX_SPAWN_SIZE = 2;
    ...
    private static final double MIN_HABITAT_HEIGHT = 0.5;
    // Defines maximum amount of blocks that this entity can get to (by going down).
    private static final double MAX_HABITAT_HEIGHT = 1;
    // How many steps this entity can live.
    private static final int MAX_AGE = 1000;

    /**
     * Constructor for Cod objects
     * @param field - the current field.
     * @param location - the location of the cod.
     * @param sim - the simulator that operates this cod actor.
     */
    public Cod(boolean randomAge, Field field, Location loc, Simulator sim) {
    ...
    protected Animal getNewAnimal(Field field, Location loc) {
        return new Cod(false, field, loc, super.getSim());
    }
    ...
    protected boolean isInHabitat(Location l) {
        ...
        int minHabitatCells = (int) Math.round(MIN_HABITAT_HEIGHT*fieldDepth) - 1;
